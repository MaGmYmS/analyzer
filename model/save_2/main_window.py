...
from model.analizator_model import Frame, Analyser, FrameBuffer
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.frame_buffer = FrameBuffer(size=10)  # Создаем буфер для последних 10 кадров
    ...
    def process_frame(self, image, number_frame):
        if self.enable_signs_detection_checkbox.isChecked():
            ...
            if number_frame % 60 == 0:
                frame.print_results()
                analyser = Analyser(self.frame_buffer, frame)
